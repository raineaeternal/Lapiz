...
MAKE_AUTO_HOOK_FIND_INSTANCE(ZenjectException_ctor_2, classof(Zenject::ZenjectException*), ".ctor_1", void, Zenject::ZenjectException* self, StringW exepMessage) {
    ERROR("ZenjectException: {}", exepMessage);
    ZenjectException_ctor_2(self, exepMessage);
}