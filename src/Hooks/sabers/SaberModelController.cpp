...
MAKE_AUTO_HOOK_MATCH(SaberModelController_Init,
                     &GlobalNamespace::SaberModelController::Init, void,
                     GlobalNamespace::SaberModelController *self,
                     ::UnityEngine::Transform *parent,
                     ::GlobalNamespace::Saber *saber,
                     ::UnityEngine::Color trailTintColor, ::StringW modelName) {
  static auto saberModelControllerKlass =
      i2c::class_of<GlobalNamespace::SaberModelController *>();
  if (self->klass == saberModelControllerKlass ||
      currentlyInvoking.find(self) != currentlyInvoking.end())
    SaberModelController_Init(self, parent, saber, trailTintColor, modelName);
  else {
