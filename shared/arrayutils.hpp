...
namespace Lapiz::ArrayUtils {
    ...
    static void box_array(ArrayW<System::Object*> arr, int index, T val)  {
    ...
    static void box_array(ArrayW<System::Object*> arr, int index, First& first, Rest&... rest) {
    ...
    template <typename First, typename... Rest>
    requires(std::is_convertible<First, System::Object*>::value || std::is_arithmetic<First>::value)
    static void box_array(ArrayW<System::Object*> arr, First& first, Rest&... rest) {
        box_array(arr, 0, first, rest...);
    }

    template<typename... Targs>
    static ArrayW<System::Object*> box_array(Targs&... rest) {
